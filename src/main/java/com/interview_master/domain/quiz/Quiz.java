...
public class Quiz extends BaseEntity {
  ...
  private void setCollection(Collection collection) {
      if (collection == null) {
          throw new ApiException(ErrorCode.NULL_EXCEPTION, "no collectionId");
      }
  ...
  private void setQuestion(String question) {
      if (question == null || question.trim().isEmpty()) {
          throw new ApiException(ErrorCode.NULL_EXCEPTION, "질문 입력은 필수 입니다.");
      }
  ...
  private void setAnswer(String answer) {
      if (answer == null || answer.trim().isEmpty()) {
          throw new ApiException(ErrorCode.NULL_EXCEPTION, "답변 입력은 필수 입니다.");
      }
    this.answer = answer;
  }
  ...
  private void setCreator(User creator) {
      if (creator == null) {
          throw new ApiException(ErrorCode.NULL_EXCEPTION, "작성자 입력은 필수 입니다.");
      }
  ...
  private void setAccess(Access access) {
      if (access == null) {
          throw new ApiException(ErrorCode.NULL_EXCEPTION, "공개 범위 설정은 필수 입니다.");
      }
    this.access = access;
  }
}
