...
public class SearchCollectionService {
  ...
  // 비로그인인 경우
  public List<CollectionWithAttemptsPaging> searchCollectionForAnonymousUser(
      List<Integer> categoryIds, List<String> keywords, Integer maxCorrectRate) {
  ...
  private Sort createSort(SortOrder sortOrder) {
    return switch (sortOrder) {
      ...
      case LOWEST_ACCURACY ->
          Sort.by(Sort.Direction.ASC, "accuracy");
    };
  }
